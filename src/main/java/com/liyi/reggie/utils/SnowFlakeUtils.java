...
public class SnowFlakeUtils {
     ...
     */
    SnowFlakeUtils(long workerId, long datacenterId, long standbyDatacenterId) {
    ...
    private volatile static SnowFlakeUtils snowflakeIdWorker;

    public static SnowFlakeUtils getInstance() {
        if (snowflakeIdWorker == null) {
            synchronized (SnowFlakeUtils.class) {
                if (snowflakeIdWorker == null) {
                    snowflakeIdWorker = new SnowFlakeUtils(1, 0,11);
                }
            }
        }
